...
const HERO_SKILLS = [
  ...
  ["shooter","speed","upgrade","Beschleunigte Geschosse",["grey","green","purple"],"+15 / +30 / +50 % Projektilspeed.","Je Stufe zusätzlich +5 Prozentpunkte."],
  ["shooter","caliber","upgrade","Größere Kaliber",["grey","green","purple"],"+10 / +20 / +35 % Projektilgröße.","Je Stufe zusätzlich +5 Prozentpunkte."],
  ["shooter","precision","upgrade","Präzisionsschuss",["grey","green","purple"],"Mittige Treffer +5 / +10 / +20 % Schaden; unbegrenzt wählbar.","Je Auswahl zusätzlich +5 Prozentpunkte."],
  ["shooter","armor","upgrade","Panzerbrecher",["grey","green","purple"],"Nach Durchschlag +10 / +20 / +35 % Schaden.","Je Stufe zusätzlich +5 Prozentpunkte."],
  ["shooter","criticalSalvo","upgrade","Kritische Salve",["grey","green","purple"],"Krits: 10 / 20 / 35 % Chance auf Zusatzschuss.","Je Stufe zusätzlich +5 Prozentpunkte."],
  ["shooter","quickHands","upgrade","Schnelle Hände",["grey","green","purple"],"Nach Krit +8 / +15 / +25 % Feuerrate für 2 s.","Je Stufe zusätzlich +5 Prozentpunkte."],
  ["shooter","heavy","upgrade","Schweres Geschoss",["grey","green","purple"],"Mehr Schaden bei geringerer Projektilgeschwindigkeit.","Je Stufe zusätzlich +5 Prozentpunkte Schaden."],
  ["shooter","light","upgrade","Leichtmunition",["grey","green","purple"],"Mehr Feuerrate bei geringerem Schaden.","Je Stufe zusätzlich +5 Prozentpunkte Feuerrate."],
  ["shooter","pierceForce","upgrade","Durchschlagswucht",["grey","green","purple"],"Letzter Treffer +20 / +40 / +70 % Schaden.","Je Stufe zusätzlich +10 Prozentpunkte."],
  ["shooter","splitter","upgrade","Splittergeschoss",["grey","green","purple"],"15 / 25 / 40 % Chance auf einen Splitter.","Je Stufe zusätzlich +5 Prozentpunkte Chance."],
  ["shooter","double","upgrade","Doppelschlag",["grey","green","purple"],"5 / 10 / 18 % Chance auf zweiten Schuss.","Je Stufe zusätzlich +5 Prozentpunkte Chance."],
  ["shooter","focus","upgrade","Zielerfassung",["grey","green","purple"],"Nach 3 Treffern +5 / +10 / +20 % Schaden.","Je Stufe zusätzlich +5 Prozentpunkte."],
  ["shooter","sustained","upgrade","Dauerfeuer",["grey","green","purple"],"Alle 10 Schüsse +10 / +15 / +25 % Feuerrate für 2 s.","Je Stufe zusätzlich +5 Prozentpunkte."],
  ["shooter","fullHit","upgrade","Volltreffer",["grey","green","purple"],"Krits verursachen zusätzlich +10 / +20 / +35 % Schaden.","Je Stufe zusätzlich +10 Prozentpunkte."],
  ["shooter","triple","upgrade","Dreifachsalve",["purple"],"Jeder 8. Schuss erzeugt 3 Zusatzgeschosse.","Bereits jeder 7. Schuss."],
  ["shooter","rain","upgrade","Geschossregen",["purple"],"Nach 20 Projektilen entstehen 3 Geschosse mit 300 % Schaden.","Bereits nach 18 Projektilen."],
  ["shooter","perfect","upgrade","Perfekter Treffer",["purple"],"Jeder 10. Haupttreffer ist garantiert kritisch.","Bereits jeder 8. Haupttreffer."],
  ["shooter","unstoppable","upgrade","Unaufhaltsam",["purple"],"Ab dem dritten Durchschlagstreffer +50 % Schaden.","+75 % statt +50 %."],
  ["shooter","overload","upgrade","Überladung",["purple"],"Nach 15 Schüssen wird die nächste Salve doppelt groß und stark.","Bereits nach 12 Schüssen und +125 % Schaden."],
  ["shooter","chain","upgrade","Kettenprojektil",["purple"],"20 % Chance auf einen Sprung zu einem sichtbaren Segment.","30 % statt 20 % Chance."],
  ["shooter","salvoMaster","upgrade","Salvenmeister",["purple"],"Nach Mehrfachschuss: alle Salvenprojektile +30 % Schaden.","+40 % statt +30 % Schaden."],
  ["shooter","precisionMode","upgrade","Präzisionsmodus",["purple"],"Nach 2 s Stillstand +25 % Schaden und +10 % Krit-Chance.","Nach 1,5 s: +30 % Schaden und +12 % Krit-Chance."],
  ["shooter","bulletStorm","upgrade","Kugelhagel",["orange"],"Alle 25 s für 5 s: +50 % Rate, +1 Projektil und +1 Durchschlag.","Alle 22 s für 6 s."],
  ["shooter","marksman","upgrade","Meisterschütze",["orange"],"Jeder 5. Treffer pro Segment: +100 % Schaden und garantiert kritisch.","Jeder 4. Treffer: +125 % Schaden."],
  ["paladin","attack","attack","Hammer des Morgenlichts",[],"Ein Hammerbogen trifft jedes berührte Segment einmal.","+45 % direkter Hammerschaden; keine Verstärkung der Explosionen."],
  ["paladin","impact","attack","Heiliger Einschlag",[],"Jeder 4. Treffer explodiert mit 50 % Hammerschaden.","90 % statt 50 % Hammerschaden."],
  ["paladin","judgment","attack","Göttliches Urteil",["orange"],"500 % Hammerschaden im großen Umkreis. Benötigt Göttlichen Zorn im Run.","1.000 % statt 500 % Hammerschaden."],
  ["paladin","morning","upgrade","Morgenlicht",["green","purple"],"20 / 50 Prozentpunkte Chance auf einen zweiten Flächentreffer.","Der Zusatztreffer verursacht 110 % statt 50 % Hammerschaden."],
  ["paladin","revenge","upgrade","Vergeltung",["purple"],"Kritische Treffer verursachen 50 % zusätzlichen Hammerschaden am Ziel.","125 % statt 50 % Zusatzschaden."],
  ["paladin","consecrated","upgrade","Geweihter Hammer",["grey"],"+20 % Hammerschaden je Auswahl, einschließlich abgeleiteter Fähigkeiten.","+40 % statt +20 % je Auswahl."],
  ...
  ["paladin","breaker","upgrade","Lichtbrecher",["grey","green","purple"],"+10 / +20 / +40 % Explosionsschaden je Auswahl.","+25 / +35 / +55 % je Auswahl."],
  ...
  ["alchemist","attack","attack","Seuchenfläschchen",[],"0,8 Direktschaden und ein Giftstapel pro Treffer.","+26 % direkter Fläschchenschaden."],
  ["alchemist","poison","attack","Toxische Mischung",[],"Jeder Stapel verursacht 0,2 Schaden pro Sekunde für 4 Sekunden.","30 % stärker: 0,26 statt 0,2 Schaden pro Sekunde."],
  ["alchemist","cloud","attack","Giftwolke",["orange"],"Alle 18 Sekunden eine vier Sekunden anhaltende Giftwolke.","16 statt 18 Sekunden Grundabklingzeit und +10 % Einschlagschaden."],
  ...
  ["alchemist","explosive","upgrade","Explosive Mischung",["grey","green","purple"],"20 / 35 / 50 % Direktschaden als Flächenschaden.","28 / 43 / 58 % Direktschaden."],
  ...
  ["alchemist","rain","upgrade","Giftregen",["orange"],"Jeder 10. Wurf trifft bis zu fünf sichtbare Segmente.","65 % statt 50 % Direktschaden."],
